...
export type MintTokenStatus = { Finalized: { tx_hash: string } } | { Unknown: null };
export type Result = { Ok: GenerateTicketOk } | { Err: GenerateTicketError };
...
export type TxAction = { Burn: null } | { Redeem: null } | { Mint: null } | { Transfer: null };
